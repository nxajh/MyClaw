...
mod tests {
    use super::*;
    use crate::api::tool_listing::StaticToolListing;
    ...
    async fn search(query: &str, limit: Option<u64>) -> serde_json::Value {
        ...
        let result = tool
            .execute(args, &crate::api::tool::ToolContext { owner: "test".to_string(), session_id: "test".to_string(), agent_name: "main".to_string(), ..Default::default() })
            .await
            .unwrap();
