//! zeroclaw-session — Domain types for session management.
//!
//! Contains the core [`SessionBackend`] trait and associated data types.
//! Implementations (SQLite, JSONL, etc.) live in `src/crates/zeroclaw-infra`.

use chrono::{DateTime, Utc};
pub use zeroclaw_api::provider::ChatMessage;
