    ...
    <div className="flex flex-col h-full bg-zinc-950">
      <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
        ...
        <div className={`${mobileShowDetail ? 'hidden md:flex' : 'flex'} w-full md:w-80 border-b md:border-b-0 md:border-r border-zinc-800 flex-col shrink-0`}>
          <div className="p-3 sm:p-4 border-b border-zinc-800 space-y-2.5">
            <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-zinc-800 bg-zinc-900/40 pl-9 pr-3 py-2 text-xs text-zinc-200 placeholder-zinc-600 outline-none focus:border-zinc-700 focus:ring-1 focus:ring-zinc-700/30 transition-colors"
              />
            </div>
          </div>
        ...
        <div className={`${mobileShowDetail ? 'flex' : 'hidden md:flex'} flex-1 overflow-y-auto bg-zinc-950 p-3 sm:p-8 flex-col`}>
          {/* Mobile back button */}
          {mobileShowDetail && (
            <button
              ...
              <div className="space-y-3">
                ...
                {activeToolSpec && Object.keys(activeToolSpec.parameters.properties).length > 0 ? (
                  <div className="rounded-2xl border border-zinc-800 bg-zinc-900/30 overflow-hidden text-xs">
                    <div className="hidden sm:grid grid-cols-4 bg-zinc-900/40 border-b border-zinc-800 px-4 py-2 text-zinc-500 font-bold">
