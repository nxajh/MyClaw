        ...
        <div className={`${mobileShowDetail ? 'flex' : 'hidden md:flex'} flex-1 overflow-y-auto bg-zinc-950 flex-col`}>
          ...
          {selectedToolName ? (
            <div className="flex flex-col min-h-full">
              {/* Sticky tool header */}
              <div className="sticky top-0 z-10 border-b border-zinc-800/80 bg-zinc-950/85 backdrop-blur-md px-3 sm:px-8 py-4 space-y-1.5">
              ...
              <div className="px-3 sm:px-8 py-5 space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  {activeToolSpec && Object.keys(activeToolSpec.parameters.properties).length > 0 ? (
                    <div className={`${panelCls} overflow-hidden text-sm`}>
                    ...
                    <div className={`${panelCls} p-5 text-center text-sm text-zinc-500 leading-normal`}>
